...
datamost=data1.loc[(data1['shot_zone_area']=='Center(C)') & (data1['shot_zone_basic']=='Mid-Range') & (data1['shot_zone_basic']=='Less Than 8 ft.')]
...
plt.title('confusion matrix - all features-RF')
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix for K features-RF')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - K features - MLP')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN1[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN1)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - hidden_layers=(100,100)')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN2[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN2)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - hidden_layers=(100,100,100)')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN3[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN3)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - hidden_layers=(100,100,100,100)')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN4[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN4)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - activation=logistic ')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN5[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN5)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - solver=sgd')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN6[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN6)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - early_stopping=True')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN7[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN7)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - momentum=0.95')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
...
print("ROC_AUC : ", roc_auc_score(y_test_NN,y_pred_score_NN8[:,1]) * 100)

# confusion matrix for all features
conf_matrix = confusion_matrix(y_test_NN, y_pred_NN8)
class_names = data1['shot_made_flag'].unique()
...
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
plt.title('confusion matrix - many changes')
plt.ylabel('True label',fontsize=20)
plt.xlabel('Predicted label',fontsize=20)
# Show heat map
plt.tight_layout()
